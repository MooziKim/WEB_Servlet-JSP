...
@Slf4j
@RequestMapping(method = RequestMapping.Method.GET, value = "/searchAction.do")
public class SearchActionController implements BaseController {
    @Override
    public String execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        return "shop/product/searchForm";
    }
}
