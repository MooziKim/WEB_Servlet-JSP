...
<div class="bg-white w-full flex flex-col gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-[#161931]">
    ...
    <main class="w-full min-h-screen py-1 md:w-2/3 lg:w-3/4">
        <div class="container mx-auto mt-8 p-4">
            <h2 class="text-2xl font-bold mb-4">포인트 사용내역 조회</h2>

            <div class="grid grid-cols-1 gap-4">
                <c:forEach var="pointInfo" items="${pointInfoList}">
                    <div class="bg-white border border-gray-300 p-4 shadow-md rounded-md">
                        <div class="mb-2 font-bold">일자: ${pointInfo.pointDate}</div>
                        <div class="mb-2">포인트: ${pointInfo.point} 원</div>
                        <div class="mb-2">사용/적립: ${pointInfo.pointInfo}</div>
                    </div>
                </c:forEach>
            </div>
            ...
            <div class="mt-4">
                <nav class="flex justify-center">
                    <ul class="pagination">
                        <li class="page-item">
                            <a href="/mypage/pointInfo.do?page=${currentPage - 1}" class="page-link" aria-label="Previous">
                        ...
                        <c:forEach var="i" begin="1" end="${pageCount}">
                            <li class="page-item">
                                <a href="/mypage/pointInfo.do?page=${i}"
                                   class="page-link ${currentPage eq i ? 'bg-blue-500 text-white' : 'hover:bg-blue-500 hover:text-white'}">${i}</a>
                            </li>
                        </c:forEach>

                        <li class="page-item">
                            <a href="/mypage/pointInfo.do?page=${currentPage + 1}" class="page-link" aria-label="Next">
